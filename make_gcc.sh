...
-Iinclude -I/usr/include/SDL2 -I src -I src/applications/lmc_application -I src/chips/trivial/lmc -I libs/imgui -I libs/glad/include -I libs/doctest -I ~/include \
-lpthread -lSDL2 -lSDL2main \
-DFMT_HEADER_ONLY \
