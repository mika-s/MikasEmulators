#ifndef MIKA_EMULATORS_Z80_APPLICATIONS_PACMAN_INPUT_SDL_H
#define MIKA_EMULATORS_Z80_APPLICATIONS_PACMAN_INPUT_SDL_H
...
#endif //MIKA_EMULATORS_Z80_APPLICATIONS_PACMAN_INPUT_SDL_H
