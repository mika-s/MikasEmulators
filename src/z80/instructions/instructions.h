...
namespace emu::z80 {
    ...
    void rl_MixyPd(u16 ixy_reg, u8 d, const EmulatorMemory &memory, Flags &flag_reg, unsigned long &cycles);
    ...
    void rlc_MixyPd(u16 ixy_reg, u8 d, const EmulatorMemory &memory, Flags &flag_reg, unsigned long &cycles);
    void rlc_MixyPd_r(u8 &reg, u16 ixy_reg, u8 d, const EmulatorMemory &memory, Flags &flag_reg, unsigned long &cycles);
    ...
    void rr_MixyPd(u16 ixy_reg, u8 d, const EmulatorMemory &memory, Flags &flag_reg, unsigned long &cycles);
    ...
    void rrc_MixyPd(u16 ixy_reg, u8 d, const EmulatorMemory &memory, Flags &flag_reg, unsigned long &cycles);
    void rrc_MixyPd_r(u8 &reg, u16 ixy_reg, u8 d, const EmulatorMemory &memory, Flags &flag_reg, unsigned long &cycles);
    ...
    void sla_MixyPd(u16 ixy_reg, u8 d, const EmulatorMemory &memory, Flags &flag_reg, unsigned long &cycles);
    void sla_MixyPd_r(u8 &reg, u16 ixy_reg, const NextByte &args, const EmulatorMemory &memory, Flags &flag_reg, unsigned long &cycles);
    void sll_r(u8 &reg, Flags &flag_reg, unsigned long &cycles);
    void sll_MHL(u8 &value_in_hl, Flags &flag_reg, unsigned long &cycles);
    void sll_MixyPd(u16 ixy_reg, u8 d, const EmulatorMemory &memory, Flags &flag_reg, unsigned long &cycles);
    void sll_MixyPd_r(u8 &reg, u16 ixy_reg, u8 d, const EmulatorMemory &memory, Flags &flag_reg, unsigned long &cycles);
    void sra_r(u8 &reg, Flags &flag_reg, unsigned long &cycles);
    void sra_MHL(u8 &value_in_hl, Flags &flag_reg, unsigned long &cycles);
    void sra_MixyPd(u16 ixy_reg, u8 d, const EmulatorMemory &memory, Flags &flag_reg, unsigned long &cycles);
    void sra_MixyPd_r(u8 &reg, u16 ixy_reg, u8 d, const EmulatorMemory &memory, Flags &flag_reg, unsigned long &cycles);
    void srl_r(u8 &reg, Flags &flag_reg, unsigned long &cycles);
    void srl_MHL(u8 &value_in_hl, Flags &flag_reg, unsigned long &cycles);
    void srl_MixyPd(u16 ixy_reg, u8 d, const EmulatorMemory &memory, Flags &flag_reg, unsigned long &cycles);
    void srl_MixyPd_r(u8 &reg, u16 ixy_reg, u8 d, const EmulatorMemory &memory, Flags &flag_reg, unsigned long &cycles);
