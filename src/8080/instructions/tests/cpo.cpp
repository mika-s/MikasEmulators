...
namespace emu::cpu8080::tests {
    TEST(CpoTest, ShouldPushCurrentPCOnTheStackAndChangePCToAddressInArgsWhenParityFlagIsUnset) {
    ...
    TEST(CpoTest, ShouldNotDoAnythingWhenParityFlagIsSet) {
        unsigned long cycles = 0;
    ...
    TEST(CpoTest, ShouldUse11CyclesWhenNotCalled) {
        unsigned long cycles = 0;
    ...
    TEST(CpoTest, ShouldUse17CyclesWhenCalled) {
        unsigned long cycles = 0;
