...
namespace emu::cpu8080::tests {
    TEST(CpTest, ShouldPushCurrentPCOnTheStackAndChangePCToAddressInArgsWhenSignFlagIsUnset) {
    ...
    TEST(CpTest, ShouldNotDoAnythingWhenSignFlagIsSet) {
        unsigned long cycles = 0;
    ...
    TEST(CpTest, ShouldUse11CyclesWhenNotCalled) {
        unsigned long cycles = 0;
    ...
    TEST(CpTest, ShouldUse17CyclesWhenCalled) {
        unsigned long cycles = 0;
