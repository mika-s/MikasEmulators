...
namespace emu::cpu8080::tests {
    TEST(RpTest, ShouldPopPCOffTheStackWhenTheSignFlagIsUnset) {
    ...
    TEST(RpTest, ShouldNotPopPCOffTheStackWhenTheSignFlagIsSet) {
        unsigned long cycles = 0;
    ...
    TEST(RpTest, ShouldUse5CyclesWhenNotReturning) {
        unsigned long cycles = 0;
    ...
    TEST(RpTest, ShouldUse11CyclesWhenReturning) {
        unsigned long cycles = 0;
