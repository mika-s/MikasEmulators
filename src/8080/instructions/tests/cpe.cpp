...
namespace emu::cpu8080::tests {
    TEST(CpeTest, ShouldPushCurrentPCOnTheStackAndChangePCToAddressInArgsWhenParityFlagIsset) {
    ...
    TEST(CpeTest, ShouldNotDoAnythingWhenParityFlagIsUnset) {
        unsigned long cycles = 0;
    ...
    TEST(CpeTest, ShouldUse11CyclesWhenNotCalled) {
        unsigned long cycles = 0;
    ...
    TEST(CpeTest, ShouldUse17CyclesWhenCalled) {
        unsigned long cycles = 0;
