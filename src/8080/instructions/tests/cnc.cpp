...
namespace emu::cpu8080::tests {
    TEST(CncTest, ShouldPushCurrentPCOnTheStackAndChangePCToAddressInArgsWhenCarryFlagIsUnset) {
    ...
    TEST(CncTest, ShouldNotDoAnythingWhenCarryFlagIsSet) {
        unsigned long cycles = 0;
    ...
    TEST(CncTest, ShouldUse11CyclesWhenNotCalled) {
        unsigned long cycles = 0;
    ...
    TEST(CncTest, ShouldUse17CyclesWhenCalled) {
        unsigned long cycles = 0;
