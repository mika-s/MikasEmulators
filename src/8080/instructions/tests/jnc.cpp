...
namespace emu::cpu8080::tests {
    TEST(JncTest, ShouldJumpWhenNotCarryFlag) {
        ...
        jnc(pc, args, flag_reg, cycles);

        EXPECT_EQ(0x2211, pc);
    }

    TEST(JncTest, ShouldNotJumpWhenCarryFlag) {
        unsigned long cycles = 0;
    ...
    TEST(JncTest, ShouldNotAffectAnyFlags) {
        unsigned long cycles = 0;
    ...
    TEST(JncTest, ShouldUse10Cycles) {
        unsigned long cycles = 0;
