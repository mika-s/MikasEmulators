#ifndef MIKA_EMULATORS_CHIPS_LMC_ASSEMBLER_TOKEN_KIND_H
#define MIKA_EMULATORS_CHIPS_LMC_ASSEMBLER_TOKEN_KIND_H
...
#endif //MIKA_EMULATORS_CHIPS_LMC_ASSEMBLER_TOKEN_KIND_H
