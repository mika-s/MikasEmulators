 ...
 */
void mult(EmulatorMemory<Address, RawData>& memory, const RawData a, const RawData b, const RawData c)
{
    memory.write(
...
void print_mult(std::ostream& ostream, const RawData a, const RawData b, const RawData c)
{
    ostream << "MULT ";
