 ...
 */
void mod(EmulatorMemory<Address, RawData>& memory, const RawData a, const RawData b, const RawData c)
{
    memory.write(
...
void print_mod(std::ostream& ostream, const RawData a, const RawData b, const RawData c)
{
    ostream << "MOD ";
