 ...
 */
void ind(u8& b_reg, u8 c_reg, u8& h_reg, u8& l_reg, EmulatorMemory<u16, u8>& memory, Flags& flag_reg,
...
TEST_CASE("LR35902: IND")
{
    ...
    SUBCASE("should store IO in HL, decrement HL, decrement B and set correct flags")
    {
        ...
        ind(b_reg, c_reg, h_reg, l_reg, memory, flag_reg, io, cycles);
    ...
    SUBCASE("should use 16 cycles")
    {
        ...
        ind(h_reg, l_reg, b_reg, c_reg, memory, flag_reg, io, cycles);
