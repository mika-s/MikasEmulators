 ...
 * @param cycles is the number of cycles variable, which will be mutated
 */
void ret_m(u16& pc, u16& sp, EmulatorMemory<u16, u8> const& memory, Flags const& flag_reg, cyc& cycles)
{
    cycles = 0;
 ...
 * @param cycles is the number of cycles variable, which will be mutated
 */
void ret_p(u16& pc, u16& sp, EmulatorMemory<u16, u8> const& memory, Flags const& flag_reg, cyc& cycles)
{
    cycles = 0;
 ...
 * @param cycles is the number of cycles variable, which will be mutated
 */
void ret_pe(u16& pc, u16& sp, EmulatorMemory<u16, u8> const& memory, Flags const& flag_reg, cyc& cycles)
{
    cycles = 0;
 ...
 * @param cycles is the number of cycles variable, which will be mutated
 */
void ret_po(u16& pc, u16& sp, EmulatorMemory<u16, u8> const& memory, Flags const& flag_reg, cyc& cycles)
{
    cycles = 0;
