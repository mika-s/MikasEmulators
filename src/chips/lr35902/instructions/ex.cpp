...
void print_ex(std::ostream& ostream, std::string const& reg, std::string const& comp_reg)
{
    ostream << "EX "
            << reg
            << ","
