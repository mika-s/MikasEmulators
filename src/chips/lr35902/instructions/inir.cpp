 ...
 */
void inir(u16& pc, u8& b_reg, u8 c_reg, u8& h_reg, u8& l_reg, EmulatorMemory<u16, u8>& memory, Flags& flag_reg,
...
TEST_CASE("LR35902: INIR")
{
    ...
    SUBCASE("should store IO in HL, increment HL, decrement B and set correct flags")
    {
        ...
        inir(pc, b_reg, c_reg, h_reg, l_reg, memory, flag_reg, io, cycles);
