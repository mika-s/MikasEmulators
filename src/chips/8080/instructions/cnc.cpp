 ...
 */
void cnc(u16& pc, u16& sp, EmulatorMemory<u16, u8>& memory, NextWord const& args, Flags const& flag_reg, cyc& cycles)
{
    cycles = 0;
...
void print_cnc(std::ostream& ostream, NextWord const& args)
{
    ostream << "CNC "
