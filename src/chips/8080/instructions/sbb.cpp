...
void sbb(u8& acc_reg, const u8 value, Flags& flag_reg)
{
 ...
 */
void sbb_r(u8& acc_reg, const u8 reg, Flags& flag_reg, cyc& cycles)
{
...
void print_sbb(std::ostream& ostream, std::string const& reg)
{
    ostream << "SBB "
            << reg;
}
