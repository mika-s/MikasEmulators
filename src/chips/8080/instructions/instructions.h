...
namespace emu::i8080 {
    ...
    void cc(u16 &pc, u16 &sp, EmulatorMemory<u16, u8> &memory, const NextWord &args, const Flags &flag_reg, cyc &cycles);
    void cm(u16 &pc, u16 &sp, EmulatorMemory<u16, u8> &memory, const NextWord &args, const Flags &flag_reg, cyc &cycles);
    ...
    void cp(u16 &pc, u16 &sp, EmulatorMemory<u16, u8> &memory, const NextWord &args, const Flags &flag_reg, cyc &cycles);
    ...
    void cz(u16 &pc, u16 &sp, EmulatorMemory<u16, u8> &memory, const NextWord &args, const Flags &flag_reg, cyc &cycles);
...
#endif //MIKA_EMULATORS_CHIPS_8080_INSTRUCTIONS_INSTRUCTIONS_H
