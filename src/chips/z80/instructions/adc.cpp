 ...
 * @param cycles is the number of cycles variable, which will be mutated
 */
void adc_A_MixyPd(u8& acc_reg, const u16 ixy_reg, NextByte const& args, EmulatorMemory<u16, u8>& memory, Flags& flag_reg, cyc& cycles)
{
 ...
 * @param cycles is the number of cycles variable, which will be mutated
 */
void adc_A_r_undoc(u8& acc_reg, const u8 value, Flags& flag_reg, cyc& cycles)
{
    adc(acc_reg, value, flag_reg);
 ...
 * @param cycles is the number of cycles variable, which will be mutated
 */
void adc_A_ixy_h_or_l(u8& acc_reg, const u8 ixy_reg_h_or_l, Flags& flag_reg, cyc& cycles)
{
