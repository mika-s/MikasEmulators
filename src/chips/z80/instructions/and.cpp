...
void print_and_r_undocumented(std::ostream& ostream, std::string const& reg)
{
    ostream << "AND "
            << reg
            << "*";
...
void print_and_MixyPn(std::ostream& ostream, std::string const& ixy_reg, NextByte const& args)
{
