#ifndef MIKA_EMULATORS_CHIPS_Z80_INSTRUCTIONS_INSTRUCTIONS_H
#define MIKA_EMULATORS_CHIPS_Z80_INSTRUCTIONS_INSTRUCTIONS_H
...
constexpr unsigned int SLL_B_UNDOC   = 0x30;
constexpr unsigned int SLL_C_UNDOC   = 0x31;
constexpr unsigned int SLL_D_UNDOC   = 0x32;
constexpr unsigned int SLL_E_UNDOC   = 0x33;
constexpr unsigned int SLL_H_UNDOC   = 0x34;
constexpr unsigned int SLL_L_UNDOC   = 0x35;
constexpr unsigned int SLL_MHL_UNDOC = 0x36;
constexpr unsigned int SLL_A_UNDOC   = 0x37;
...
constexpr unsigned int RL_MIXY_P_n_B_UNDOC   = 0x10;
constexpr unsigned int RL_MIXY_P_n_C_UNDOC   = 0x11;
constexpr unsigned int RL_MIXY_P_n_D_UNDOC   = 0x12;
constexpr unsigned int RL_MIXY_P_n_E_UNDOC   = 0x13;
constexpr unsigned int RL_MIXY_P_n_H_UNDOC   = 0x14;
constexpr unsigned int RL_MIXY_P_n_L_UNDOC   = 0x15;
constexpr unsigned int RL_MIXY_P_n           = 0x16;
constexpr unsigned int RL_MIXY_P_n_A_UNDOC   = 0x17;
...
// EXTD opcodes:
constexpr unsigned int IN_B_C          = 0x40;
constexpr unsigned int OUT_C_B         = 0x41;
...
constexpr unsigned int IN_C_C          = 0x48;
constexpr unsigned int OUT_C_C         = 0x49;
...
namespace emu::z80 {
    ...
    void adc_A_MixyPd(u8 &reg, u16 ixy_reg, const NextByte &args, EmulatorMemory &memory, Flags &flag_reg, cyc &cycles);
    ...
    void add_A_ixy_h_or_l(u8 &acc_reg, u8 ixy_reg, Flags &flag_reg, cyc &cycles);
    void add_A_MixyPd(u8 &reg, u16 ixy_reg, const NextByte &args, EmulatorMemory &memory, Flags &flag_reg, cyc &cycles);
    ...
    void add_ixy_pp(u16 &ix_reg, u16 value_to_add, Flags &flag_reg, cyc &cycles);
    void and_MixyPd(u8 &acc_reg, u16 ixy_reg, const NextByte &args, EmulatorMemory &memory, Flags &flag_reg, cyc &cycles);
    ...
    void call_nz(u16 &pc, u16 &sp, EmulatorMemory &memory, const NextWord &args, const Flags &flag_reg, cyc &cycles);
    void call_z(u16 &pc, u16 &sp, EmulatorMemory &memory, const NextWord &args, const Flags &flag_reg, cyc &cycles);
    void call_nc(u16 &pc, u16 &sp, EmulatorMemory &memory, const NextWord &args, const Flags &flag_reg, cyc &cycles);
    void call_c(u16 &pc, u16 &sp, EmulatorMemory &memory, const NextWord &args, const Flags &flag_reg, cyc &cycles);
    void call_po(u16 &pc, u16 &sp, EmulatorMemory &memory, const NextWord &args, const Flags &flag_reg, cyc &cycles);
    void call_pe(u16 &pc, u16 &sp, EmulatorMemory &memory, const NextWord &args, const Flags &flag_reg, cyc &cycles);
    void call_p(u16 &pc, u16 &sp, EmulatorMemory &memory, const NextWord &args, const Flags &flag_reg, cyc &cycles);
    void call_m(u16 &pc, u16 &sp, EmulatorMemory &memory, const NextWord &args, const Flags &flag_reg, cyc &cycles);
    void ccf(Flags &flag_reg, u8 acc_reg, cyc &cycles);
    void cpd(u8 &b_reg, u8 &c_reg, u8 &h_reg, u8 &l_reg, u8 acc_reg, const EmulatorMemory &memory, Flags &flag_reg, cyc &cycles);
    void cpdr(u16 &pc, u8 &b_reg, u8 &c_reg, u8 &h_reg, u8 &l_reg, u8 acc_reg, const EmulatorMemory &memory, Flags &flag_reg, cyc &cycles);
    void cpi(u8 &b_reg, u8 &c_reg, u8 &h_reg, u8 &l_reg, u8 acc_reg, const EmulatorMemory &memory, Flags &flag_reg, cyc &cycles);
    void cpir(u16 &pc, u8 &b_reg, u8 &c_reg, u8 &h_reg, u8 &l_reg, u8 acc_reg, const EmulatorMemory &memory, Flags &flag_reg, cyc &cycles);
    ...
    void cp_MixyPd(u8 &acc_reg, u16 ixy_reg, const NextByte &args, EmulatorMemory &memory, Flags &flag_reg, cyc &cycles);
    ...
    void dec_ixy(u16 &ix_or_iy, cyc &cycles);
    ...
    void exx(u8 &b_reg, u8 &c_reg, u8 &b_p_reg, u8 &c_p_reg, u8 &d_reg, u8 &e_reg, u8 &d_p_reg, u8 &e_p_reg, u8 &h_reg, u8 &l_reg, u8 &h_p_reg, u8 &l_p_reg, cyc &cycles);
    ...
    void ind(u8 &b_reg, u8 c_reg, u8 &h_reg, u8 &l_reg, EmulatorMemory &memory, Flags &flag_reg, std::vector<u8> io, cyc &cycles);
    void indr(u16 &pc, u8 &b_reg, u8 c_reg, u8 &h_reg, u8 &l_reg, EmulatorMemory &memory, Flags &flag_reg, std::vector<u8> io, cyc &cycles);
    void ini(u8 &b_reg, u8 c_reg, u8 &h_reg, u8 &l_reg, EmulatorMemory &memory, Flags &flag_reg, std::vector<u8> io, cyc &cycles);
    void inir(u16 &pc, u8 &b_reg, u8 c_reg, u8 &h_reg, u8 &l_reg, EmulatorMemory &memory, Flags &flag_reg, std::vector<u8> io, cyc &cycles);
    ...
    void ld_A_Mnn(u8 &reg, const EmulatorMemory &memory, const NextWord &args, cyc &cycles);
    ...
    void ld_dd_Mnn(u8 &reg1, u8 &reg2, const NextWord &args, const EmulatorMemory &memory, cyc &cycles);
    ...
    void ldd(u8 &b_reg, u8 &c_reg, u8 &d_reg, u8 &e_reg, u8 &h_reg, u8 &l_reg, u8 acc_reg, EmulatorMemory &memory, Flags &flag_reg, cyc &cycles);
    void lddr(u16 &pc, u8 &b_reg, u8 &c_reg, u8 &d_reg, u8 &e_reg, u8 &h_reg, u8 &l_reg, u8 acc_reg, EmulatorMemory &memory, Flags &flag_reg, cyc &cycles);
    void ldi(u8 &b_reg, u8 &c_reg, u8 &d_reg, u8 &e_reg, u8 &h_reg, u8 &l_reg, u8 acc_reg, EmulatorMemory &memory, Flags &flag_reg, cyc &cycles);
    void ldir(u16 &pc, u8 &b_reg, u8 &c_reg, u8 &d_reg, u8 &e_reg, u8 &h_reg, u8 &l_reg, u8 acc_reg, EmulatorMemory &memory, Flags &flag_reg, cyc &cycles);
    ...
    void or_MixyPd(u8 &acc_reg, u16 ixy_reg, const NextByte &args, EmulatorMemory &memory, Flags &flag_reg, cyc &cycles);
    ...
    void outd(u8 &b_reg, u8 c_reg, u8 &h_reg, u8 &l_reg, EmulatorMemory &memory, Flags &flag_reg, std::vector<u8> io, cyc &cycles);
    void otdr(u16 &pc, u8 &b_reg, u8 c_reg, u8 &h_reg, u8 &l_reg, EmulatorMemory &memory, Flags &flag_reg, std::vector<u8> io, cyc &cycles);
    void otir(u16 &pc, u8 &b_reg, u8 c_reg, u8 &h_reg, u8 &l_reg, EmulatorMemory &memory, Flags &flag_reg, std::vector<u8> io, cyc &cycles);
    void outi(u8 &b_reg, u8 c_reg, u8 &h_reg, u8 &l_reg, EmulatorMemory &memory, Flags &flag_reg, std::vector<u8> io, cyc &cycles);
    ...
    void sbc_A_MixyPd(u8 &acc_reg, u16 ixy_reg, const NextByte &args, EmulatorMemory &memory, Flags &flag_reg, cyc &cycles);
    ...
    void sla_MixyPd_r(u8 &reg, u16 ixy_reg, const NextByte &args, EmulatorMemory &memory, Flags &flag_reg, cyc &cycles);
    ...
    void xor_MixyPd(u8 &acc_reg, u16 ixy_reg, const NextByte &args, EmulatorMemory &memory, Flags &flag_reg, cyc &cycles);
...
#endif //MIKA_EMULATORS_CHIPS_Z80_INSTRUCTIONS_INSTRUCTIONS_H
