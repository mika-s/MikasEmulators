...
void adc_A_MixyPd(u8& reg, u16 ixy_reg, NextByte const& args, EmulatorMemory<u16, u8>& memory, Flags& flag_reg, cyc& cycles);
...
void add_A_MixyPd(u8& reg, u16 ixy_reg, NextByte const& args, EmulatorMemory<u16, u8>& memory, Flags& flag_reg, cyc& cycles);
...
void and_MixyPd(u8& acc_reg, u16 ixy_reg, NextByte const& args, EmulatorMemory<u16, u8>& memory, Flags& flag_reg, cyc& cycles);
...
void call_po(u16& pc, u16& sp, EmulatorMemory<u16, u8>& memory, NextWord const& args, Flags const& flag_reg, cyc& cycles);
void call_pe(u16& pc, u16& sp, EmulatorMemory<u16, u8>& memory, NextWord const& args, Flags const& flag_reg, cyc& cycles);
void call_p(u16& pc, u16& sp, EmulatorMemory<u16, u8>& memory, NextWord const& args, Flags const& flag_reg, cyc& cycles);
void call_m(u16& pc, u16& sp, EmulatorMemory<u16, u8>& memory, NextWord const& args, Flags const& flag_reg, cyc& cycles);
void ccf(Flags& flag_reg, u8 acc_reg, cyc& cycles);
void cpd(u8& b_reg, u8& c_reg, u8& h_reg, u8& l_reg, u8 acc_reg, EmulatorMemory<u16, u8> const& memory, Flags& flag_reg, cyc& cycles);
void cpdr(u16& pc, u8& b_reg, u8& c_reg, u8& h_reg, u8& l_reg, u8 acc_reg, EmulatorMemory<u16, u8> const& memory, Flags& flag_reg, cyc& cycles);
void cpi(u8& b_reg, u8& c_reg, u8& h_reg, u8& l_reg, u8 acc_reg, EmulatorMemory<u16, u8> const& memory, Flags& flag_reg, cyc& cycles);
void cpir(u16& pc, u8& b_reg, u8& c_reg, u8& h_reg, u8& l_reg, u8 acc_reg, EmulatorMemory<u16, u8> const& memory, Flags& flag_reg, cyc& cycles);
void cp_r(const u8& acc_reg, u8 value, Flags& flag_reg, cyc& cycles);
void cp_r_undoc(const u8& acc_reg, u8 value, Flags& flag_reg, cyc& cycles);
void cp_n(const u8& acc_reg, NextByte const& args, Flags& flag_reg, cyc& cycles);
void cp_MHL(const u8& acc_reg, u8 value, Flags& flag_reg, cyc& cycles);
void cp_MixyPd(const u8& acc_reg, u16 ixy_reg, NextByte const& args, EmulatorMemory<u16, u8>& memory, Flags& flag_reg, cyc& cycles);
void cp_ixy_h_or_l(const u8& acc_reg, u8 ixy_reg_h_or_l, Flags& flag_reg, cyc& cycles);
...
void in_r_C(u8& reg, u8 b_reg, u8 c_reg, const std::vector<u8> &io, Flags& flag_reg, cyc& cycles);
...
void ind(u8& b_reg, u8 c_reg, u8& h_reg, u8& l_reg, EmulatorMemory<u16, u8>& memory, Flags& flag_reg, const std::vector<u8> &io, cyc& cycles);
void indr(u16& pc, u8& b_reg, u8 c_reg, u8& h_reg, u8& l_reg, EmulatorMemory<u16, u8>& memory, Flags& flag_reg, const std::vector<u8> &io, cyc& cycles);
void ini(u8& b_reg, u8 c_reg, u8& h_reg, u8& l_reg, EmulatorMemory<u16, u8>& memory, Flags& flag_reg, const std::vector<u8> &io, cyc& cycles);
void inir(u16& pc, u8& b_reg, u8 c_reg, u8& h_reg, u8& l_reg, EmulatorMemory<u16, u8>& memory, Flags& flag_reg, const std::vector<u8> &io, cyc& cycles);
...
void outd(u8& b_reg, u8 c_reg, u8& h_reg, u8& l_reg, EmulatorMemory<u16, u8>& memory, Flags& flag_reg, const std::vector<u8> &io, cyc& cycles);
void otdr(u16& pc, u8& b_reg, u8 c_reg, u8& h_reg, u8& l_reg, EmulatorMemory<u16, u8>& memory, Flags& flag_reg, const std::vector<u8> &io, cyc& cycles);
void otir(u16& pc, u8& b_reg, u8 c_reg, u8& h_reg, u8& l_reg, EmulatorMemory<u16, u8>& memory, Flags& flag_reg, const std::vector<u8> &io, cyc& cycles);
void outi(u8& b_reg, u8 c_reg, u8& h_reg, u8& l_reg, EmulatorMemory<u16, u8>& memory, Flags& flag_reg, const std::vector<u8> &io, cyc& cycles);
...
void sbc_A_MixyPd(u8& acc_reg, u16 ixy_reg, NextByte const& args, EmulatorMemory<u16, u8>& memory, Flags& flag_reg, cyc& cycles);
...
void sla_MixyPd_r(u8& reg, u16 ixy_reg, NextByte const& args, EmulatorMemory<u16, u8>& memory, Flags& flag_reg, cyc& cycles);
...
void xor_MixyPd(u8& acc_reg, u16 ixy_reg, NextByte const& args, EmulatorMemory<u16, u8>& memory, Flags& flag_reg, cyc& cycles);
...
void print_add_MixyPn(std::ostream& ostream, std::string const& reg, std::string const& ixy_reg, NextByte const& args);
...
void print_sbc_MixyPn(std::ostream& ostream, std::string const& reg, std::string const& ixy_reg, NextByte const& args);
