...
namespace emu::z80 {
    ...
    void adc_A_MixyPd(u8 &reg, u16 ixy_reg, const NextByte &args, EmulatorMemory<u16, u8> &memory, Flags &flag_reg, cyc &cycles);
    ...
    void add_A_MixyPd(u8 &reg, u16 ixy_reg, const NextByte &args, EmulatorMemory<u16, u8> &memory, Flags &flag_reg, cyc &cycles);
    ...
    void and_MixyPd(u8 &acc_reg, u16 ixy_reg, const NextByte &args, EmulatorMemory<u16, u8> &memory, Flags &flag_reg, cyc &cycles);
    ...
    void call_nz(u16 &pc, u16 &sp, EmulatorMemory<u16, u8> &memory, const NextWord &args, const Flags &flag_reg, cyc &cycles);
    void call_z(u16 &pc, u16 &sp, EmulatorMemory<u16, u8> &memory, const NextWord &args, const Flags &flag_reg, cyc &cycles);
    void call_nc(u16 &pc, u16 &sp, EmulatorMemory<u16, u8> &memory, const NextWord &args, const Flags &flag_reg, cyc &cycles);
    void call_c(u16 &pc, u16 &sp, EmulatorMemory<u16, u8> &memory, const NextWord &args, const Flags &flag_reg, cyc &cycles);
    void call_po(u16 &pc, u16 &sp, EmulatorMemory<u16, u8> &memory, const NextWord &args, const Flags &flag_reg, cyc &cycles);
    void call_pe(u16 &pc, u16 &sp, EmulatorMemory<u16, u8> &memory, const NextWord &args, const Flags &flag_reg, cyc &cycles);
    void call_p(u16 &pc, u16 &sp, EmulatorMemory<u16, u8> &memory, const NextWord &args, const Flags &flag_reg, cyc &cycles);
    void call_m(u16 &pc, u16 &sp, EmulatorMemory<u16, u8> &memory, const NextWord &args, const Flags &flag_reg, cyc &cycles);
    void ccf(Flags &flag_reg, u8 acc_reg, cyc &cycles);
    void cpd(u8 &b_reg, u8 &c_reg, u8 &h_reg, u8 &l_reg, u8 acc_reg, const EmulatorMemory<u16, u8> &memory, Flags &flag_reg, cyc &cycles);
    void cpdr(u16 &pc, u8 &b_reg, u8 &c_reg, u8 &h_reg, u8 &l_reg, u8 acc_reg, const EmulatorMemory<u16, u8> &memory, Flags &flag_reg, cyc &cycles);
    void cpi(u8 &b_reg, u8 &c_reg, u8 &h_reg, u8 &l_reg, u8 acc_reg, const EmulatorMemory<u16, u8> &memory, Flags &flag_reg, cyc &cycles);
    void cpir(u16 &pc, u8 &b_reg, u8 &c_reg, u8 &h_reg, u8 &l_reg, u8 acc_reg, const EmulatorMemory<u16, u8> &memory, Flags &flag_reg, cyc &cycles);
    ...
    void cp_MixyPd(u8 &acc_reg, u16 ixy_reg, const NextByte &args, EmulatorMemory<u16, u8> &memory, Flags &flag_reg, cyc &cycles);
    ...
    void ld_A_Mnn(u8 &reg, const EmulatorMemory<u16, u8> &memory, const NextWord &args, cyc &cycles);
    ...
    void ld_dd_Mnn(u8 &reg1, u8 &reg2, const NextWord &args, const EmulatorMemory<u16, u8> &memory, cyc &cycles);
    ...
    void or_MixyPd(u8 &acc_reg, u16 ixy_reg, const NextByte &args, EmulatorMemory<u16, u8> &memory, Flags &flag_reg, cyc &cycles);
    ...
    void sbc_A_MixyPd(u8 &acc_reg, u16 ixy_reg, const NextByte &args, EmulatorMemory<u16, u8> &memory, Flags &flag_reg, cyc &cycles);
    ...
    void sla_MixyPd_r(u8 &reg, u16 ixy_reg, const NextByte &args, EmulatorMemory<u16, u8> &memory, Flags &flag_reg, cyc &cycles);
    ...
    void xor_MixyPd(u8 &acc_reg, u16 ixy_reg, const NextByte &args, EmulatorMemory<u16, u8> &memory, Flags &flag_reg, cyc &cycles);
