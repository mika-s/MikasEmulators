...
namespace emu::applications::lmc {
    ...
    class GuiImgui : public Ui, public CodeEditorPaneObserver, public TerminalPaneObserver {
    ...
    public:
        ...
        void input_sent(const std::string &input) override;
    ...
    private:
        ...
        void notify_ui_observers_about_source_code_change(const std::string &source_code);
